...
def run_adaptive_watermark_orchestration(
    ...
    for attempt, strat in enumerate(strategies, 1):
        ...
        for i, wm in enumerate(watermarks):
            ...
            # Use hybrid_detector from imported module
            if hybrid_watermark.hybrid_detector.generate_static_mask(input_video, wm['coordinates'], mpath, padding_ratio=pad_ratio, semantic_class=wm.get("semantic_class", "unknown")):
                masks.append(mpath)
