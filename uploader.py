...
if os.path.exists(TOKEN_FILE):
    logger.info("ℹ️ NOTE: Community Promotion requires re-authentication (delete token.json). Uploads will continue normally without it.")
...
def _upload_sync(
    ...
    if title and title.strip():
        ...
        logger.warning("⚠️ Title was empty or whitespace. Defaulting to 'Untitled'.")
